...
class DataStorage1 {
    ...
    public DataStorage1(EventManager event_manager) {
...
class StopWordFilter1 {
    private EventManager event_manager;
    private List<String> stop_words;

    public StopWordFilter1(EventManager event_manager) {
        this.event_manager = event_manager;
...
class WordFrequencyCounter1 {
    private EventManager event_manager;
    private Map<String, Integer> word_freqs;

    public WordFrequencyCounter1(EventManager event_manager) {
        this.event_manager = event_manager;
...
class WordFrequencyApplication1 {

    private EventManager event_manager;

    public WordFrequencyApplication1(EventManager event_manager) {
        this.event_manager = event_manager;
...
class WordsWithZ1 {
    ...
    public WordsWithZ1(EventManager event_manager) {
        this.event_manager = event_manager;
        this.event_manager.subscribe("valid_word", this.increment_count);
...
class Fifteen {
    public static void main(String[] args) {
        ...
        new DataStorage1(event_manager);
        new StopWordFilter1(event_manager);
        new WordFrequencyCounter1(event_manager);
        new WordFrequencyApplication1(event_manager);
        new WordsWithZ1(event_manager);
